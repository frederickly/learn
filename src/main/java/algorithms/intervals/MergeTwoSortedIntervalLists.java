 ...
 *
 * Merge two sorted (ascending) lists of interval and return it as a new sorted list. The new sorted list should be made by splicing together the algorithms.intervals of the two lists and sorted in ascending order.
 * Example
 *
 * Example1
 *
 ...
 * Notice
 *
 *     The algorithms.intervals in the given list do not overlap.
 *     The algorithms.intervals in different lists may overlap
 */
