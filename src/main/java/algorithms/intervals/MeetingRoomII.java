 ...
 *
 * Given an array of meeting time algorithms.intervals consisting of start and end times [[s1,e1],[s2,e2],...] (si < ei), find the minimum number of conference rooms required.
 * Example
 *
 * Example1
 *
 * Input: algorithms.intervals = [(0,30),(5,10),(15,20)]
 * Output: 2
 * Explanation:
 ...
 * Example2
 *
 * Input: algorithms.intervals = [(2,7)]
 * Output: 1
 * Explanation:
...
public class MeetingRoomII {
    /**
     * @param intervals: an array of meeting time algorithms.intervals
