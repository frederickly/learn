 ...
 *
 * Given a Binary Search Tree (BST) with the root node root, return the minimum difference between the values of any two different nodes in the algorithms.tree.
 * Example
 *
 * Example 1:
 *
 ...
 *
 * The given algorithms.tree {2,1} is represented by the following diagram:
 *
 *       2
 *      /
 *     1
 *
 * while the minimum difference in this algorithms.tree is 1, it occurs between node 1 and node 2, also between node 3 and node 2.
 *
 * Example 2:
 *
 ...
 * Note that root is a TreeNode object, not an array.
 *
 * The given algorithms.tree [4,2,6,1,3,null,null] is represented by the following diagram:
 *
 *           4
 *         /   \
 *       2      6
 ...
 *     1   3
 *
 * while the minimum difference in this algorithms.tree is 1.
 *
 * Notice
 *
