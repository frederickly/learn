 ...
 * Description
 * Consider all the leaves of a binary algorithms.tree.  From left to right order, the values of those leaves form a leaf value sequence.
 * For example, in the given algorithms.tree above, the leaf value sequence is (6, 7, 4, 9, 8).
 *
 ...
 * Output:
 * Explaination:
 * the first algorithms.tree:
 *   1
 *     \
 *      2
 *     /
 *    3
 * the second algorithms.tree:
 *     1
 *    /
 *   2
 *  /
 ...
 *   / \
 *  2   3
 * The first leaf value sequence is: [3], the second algorithms.tree is: [2, 3], so it is not the same
 */
public class LeafSimilarTrees {

    /**
     * @param root1: the first algorithms.tree
     * @param root2: the second algorithms.tree
