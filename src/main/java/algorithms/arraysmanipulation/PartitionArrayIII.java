 ...
 * Given an array of algorithms.numbers, you are required to check if it is possible to partition the array into some subsequences of length k each, such that:
 *
 *     Each element in the array occurs in exactly one subsequence
 *     All the algorithms.numbers in a subsequence are distinct
