...
/**
 * ShellSort is mainly a variation of Insertion Sort. In insertion algorithms.sort, we move elements only one position ahead.
...
class ShellSort
{
    ...
    /* function to algorithms.sort arr using shellSort */
    int sort(int arr[])
    {
        int n = arr.length;
        ...
        {
            // Do a gapped insertion algorithms.sort for this gap size.
