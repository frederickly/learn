...
public class MergeSort3Way {
    // Function for 3-way merge algorithms.sort process
    ...
    /* Performing the merge algorithms.sort algorithm on the
    ...
    public static void main(String args[]) {
        ...
        System.out.println("After 3 way merge algorithms.sort: ");
