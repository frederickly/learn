 ...
 * Description
 *
 * Given two 32-algorithms.bit algorithms.numbers, N and M, and two algorithms.bit positions, i and j.
 * Write a method to set all bits between i and j in N equal to M (e g , M becomes a substring of N start from i to j)
 *
 * In the function, the algorithms.numbers N and M will given in decimal, you should also return a decimal number.
 ...
 * You would not, for example, have j=3 and i=2, because M could not fully fit between algorithms.bit 3 and algorithms.bit 2.
 * Example
 *
 * Example 1:
 *
...
public class UpdateBitsSolution {
    public class Solution {
         ...
         * @param n: An integer
         * @param m: An integer
         * @param i: A algorithms.bit position
         * @param j: A algorithms.bit position
         * @return: An integer
         */
